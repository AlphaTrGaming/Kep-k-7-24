...
exports.run = (client, message, args) => {
    ...
    if (sayMessage.length < 1) return message.channel.send(new Discord.RichEmbed().setColor('RANDOM').setTitle('Rol oluştur;').setDescription(message.author.tag + ', kullanım: tr!rol-oluştur <mesaj>.').setFooter('Kepçük Baba ', client.user.avatarURL).setTimestamp());
